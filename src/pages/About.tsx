        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="glass rounded-2xl p-8 md:p-12">
              <h2 className="text-2xl font-display font-bold text-heading mb-4">{t('mission.heading')}</h2>
          ...
          >
            <h2 className="text-2xl font-display font-bold text-heading mb-8 text-center">
              {t('valuesTitle')}
            </h2>
