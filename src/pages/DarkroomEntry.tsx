...
function getColors(theme: 'dark' | 'light') {
  ...
  return {
    ...
    iconBoxBg: 'rgba(200,147,90,0.08)',
    iconBoxBorder: 'rgba(200,147,90,0.12)',
    orColor: 'rgba(255,255,254,0.35)',
    skipColor: '#C0C0C0',
    hintColor: '#C0C0C0',
    spotlightColor: 'rgba(200,147,90,0.04)',
    vignetteColor: 'rgba(0,0,0,0.6)',
    titleShadow: '0 0 40px rgba(200,147,90,0.25), 0 0 80px rgba(200,147,90,0.1)',
    logoFilter: 'brightness(1.15) drop-shadow(0 0 40px rgba(200,147,90,0.25)) drop-shadow(0 0 80px rgba(200,147,90,0.1))',
    researcherHover: 'linear-gradient(170deg, rgba(200,147,90,0.06) 0%, rgba(139,0,0,0.03) 100%)',
    developerHover: 'linear-gradient(170deg, rgba(200,147,90,0.06) 0%, rgba(92,124,250,0.04) 100%)',
    featureIconBg: 'rgba(200,147,90,0.08)',
    featureIconBorder: 'rgba(200,147,90,0.12)',
  };
}
